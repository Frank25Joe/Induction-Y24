...
class Metaclass_PrintJob(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.PrintJob')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _print_job
...
class PrintJob(metaclass=Metaclass_PrintJob):
    from custom_interfaces.srv._print_job import PrintJob_Request as Request
    from custom_interfaces.srv._print_job import PrintJob_Response as Response
